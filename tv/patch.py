#!/usr/bin/env python3
# =============================================================================
#  iyf/tv/patch.py —— 给 tv.ifvod.classic（Android TV 客户端）打去广告 / 全 VIP 补丁。
...
def main():
    ap = argparse.ArgumentParser(description="Patch the tv.ifvod.classic APK (ad-free / full VIP).")
    ...
    try:
        ...
        print()
        print(f">>> 完成: {out}")
        print(f'>>> 安装:  adb uninstall tv.ifvod.classic ; adb install -r "{out}"')
    finally:
